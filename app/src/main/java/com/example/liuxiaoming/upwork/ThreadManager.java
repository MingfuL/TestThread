...
public class ThreadManager {
    ...
    private static volatile ExecutorService executorManual = null; // 手动提交 使用
     ...
     * @return
     */
    public static ExecutorService getUploadsericePool() {
     ...
     * @return
     */
    public static ExecutorService getManualPool() {
        if (executorManual == null) {
            synchronized (ExecutorService.class) {
                if (executorManual == null) {
                    executorManual = Executors.newFixedThreadPool(1);
                }
            }
        }
